...
//----------------------------------------------------------------
const download_status_element = document.getElementById("download-progress-text");
const progress_to_string = (progress) => progress <= 1 ? `${Math.round(progress * 100)}%` : `${progress} bytes`;
listen("download_status", (event) => {
