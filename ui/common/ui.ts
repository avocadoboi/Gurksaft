...
function overlay_color_for_element(element: HTMLElement): string {
...
*/
function update_ripple(time_stamp: DOMHighResTimeStamp, element: HTMLElement): void {
    let ripple_start_time: DOMHighResTimeStamp | undefined = (element as any).ripple_start_time;
...
function add_ripple(element: HTMLElement, event: MouseEvent): void {
...
const elements_with_ripple = document.getElementsByClassName("ripple") as HTMLCollectionOf<HTMLElement>;
